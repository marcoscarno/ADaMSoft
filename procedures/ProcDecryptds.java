...
/**
* This is the procedure that decodes a dataset
* @author marco.scarno@gmail.com
* @date 13/02/2017
*/
public class ProcDecryptds extends ADaMSoftFunctions implements RunStep
{
	/**
	* Starts the execution of Proc Decryptds and returns the corresponding message
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		String [] requiredparameters=new String[] {Keywords.OUT.toLowerCase(), Keywords.dict, Keywords.decrypdstwith};
		...
		String decryptwith=(String)parameters.get(Keywords.decrypdstwith);

		String keyword="Decryptds "+dict.getkeyword();
		String description="Decryptds "+dict.getdescription();
		...
		while (!data.isLast())
		{
			...
			if (values!=null)
			{
				...
				{
					values[i]=DECRYPT(values[i], decryptwith);
				}
				dw.write(values);
			}
		}
	...
	*/
	public LinkedList<GetRequiredParameters> getparameters()
	{
		...
		dep = new String[1];
		dep[0]=Keywords.dict;
		parameters.add(new GetRequiredParameters(Keywords.decrypdstwith, "text", true, 2656, dep, "", 2));
