...
/**
* This is the procedure that copies a dataset
* @author marco.scarno@gmail.com
* @date 13/02/2017
*/
public class ProcCopy implements RunStep
{
	/**
	...
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String keyword="Copy "+dict.getkeyword();
		String description="Copy "+dict.getdescription();
