...
/**
* This is the procedure that evaluate the trace of a matrix
* @author marco.scarno@gmail.com
* @date 14/02/2017
*/
public class ProcMattrace implements RunStep
{
	/**
	* Starts the execution of Proc Mattrace and returns the corresponding message
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String keyword="Mattrace "+dict.getkeyword();
		String description="Mattrace "+dict.getdescription();
		...
		dsu.addnewvar("v0", "%1168%", Keywords.NUMSuffix, temph, temph);

		if (!dw.opendatatable(dsu.getfinalvarinfo()))
			return new Result(dw.getmessage(), false, null);

		String[] valcond=new String[1];
		valcond[0]=String.valueOf(det);
		dw.write(valcond);
