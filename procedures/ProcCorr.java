...
/**
* This is the procedure that evaluate the correlations between row and column variables
* @author marco.scarno@gmail.com
* @date 13/02/2017
*/
public class ProcCorr extends ObjectTransformer implements RunStep
{
	/**
	* Starts the execution of Proc Corr
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String keyword="Corr "+dict.getkeyword();
		String description="Corr "+dict.getdescription();
