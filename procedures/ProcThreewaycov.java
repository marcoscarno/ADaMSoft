...
/**
* This is the procedure that evaluates the covariances for a three way array
* @author marco.scarno@gmail.com
* @date 14/02/2017
*/
public class ProcThreewaycov extends ObjectTransformer implements RunStep
{
	/**
	* Starts the execution of Proc Threewaycov
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String keyword="Threeway cov "+dict.getkeyword();
		String description="Threeway cov "+dict.getdescription();
		...
		CovariancesEvaluator covtot=new CovariancesEvaluator(true, samplevariance);
		CovariancesEvaluator covtime=new CovariancesEvaluator(true, samplevariance);
		CovariancesEvaluator covobs=new CovariancesEvaluator(true, samplevariance);
		...
		dsu.addnewvar("rif", "%1368%", Keywords.TEXTSuffix, clvar, tempmd);
