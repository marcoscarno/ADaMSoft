...
/**
* This procedure creates a dictionary for a HSQLDB local data table
* @author marco.scarno@gmail.com
* @date 14/02/2017
*/
public class ProcHsqldblocal2dict implements RunStep
{
	/**
	* Creates a dictionary for a data table stored in a local HSQLDB file
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		String [] requiredparameters=new String[] {Keywords.hsqldblocal_dbfile, Keywords.table};
		String [] optionalparameters=new String[] {Keywords.hsqldblocal_password, Keywords.hsqldblocal_user};
		...
		String keyword=Keywords.Hsqldblocal+" "+table;
		String description=Keywords.Hsqldblocal+" "+table;
		String author=(String) parameters.get(Keywords.client_host.toLowerCase());
		String datatabletype=Keywords.Hsqldblocal;
		...
		datatableinfo.put(Keywords.dbfile.toLowerCase(), db);
		...
		try
		{
			...
			for(int i=0;i<meta.getColumnCount();i++)
			{
				...
				temptablevariableinfo.put(Keywords.HsqldbLocalVariableName.toLowerCase(), name);
	...
	public LinkedList<GetRequiredParameters> getparameters()
	{
		...
		parameters.add(new GetRequiredParameters(Keywords.hsqldblocal + "=","setting=hsqldblocal", true, 1451, dep, "", 1));
		parameters.add(new GetRequiredParameters(Keywords.table, "text", true, 1452, dep, "", 2));
		return parameters;
	}
