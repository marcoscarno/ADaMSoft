...
/**
* This is the procedure that Solves A*X = B and At*Xt=Bt, given A and B
* @author marco.scarno@gmail.com
* @date 14/02/2017
*/
public class ProcMatsolvet implements RunStep
{
	/**
	* Starts the execution of Proc Matsolve and returns the corresponding message
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String keyword="Matsolvetranspose "+dicta.getkeyword()+" "+dictb.getkeyword();
		String description="Matsolvetranspose "+dicta.getdescription()+" "+dicta.getdescription();
		...
		try
		{
			...
			matRES=algebra.solveTranspose(matA, matB);
