...
/**
* This is the procedure that traspose a matrix
* @author marco.scarno@gmail.com
* @date 14/02/2017
*/
public class ProcMattranspose implements RunStep
{
	/**
	* Starts the execution of Proc Mattranspose and returns the corresponding message
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String keyword="Mattrasnpose "+dict.getkeyword();
		String description="Mattrasnpose "+dict.getdescription();
		...
		for (int i=0; i<totalvar; i++)
		{
			...
			{
				values[j]=String.valueOf(matA.get(j,i));
			}
			dw.write(values);
		}
