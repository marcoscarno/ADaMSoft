...
import ADaMSoft.algorithms.LinRegCoeffEvaluator;
...
/**
* This is the procedure that evaluate the matrix of the linear regression coefficients between row and column variables
* @author marco.scarno@gmail.com
* @date 14/02/2017
*/
public class ProcLinregcoeff extends ObjectTransformer implements RunStep
{
	/**
	* Starts the execution of Proc Linregcoeff
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String keyword="Linregcoeff "+dict.getkeyword();
		String description="Linregcoeff "+dict.getdescription();
		...
		LinRegCoeffEvaluator ec=new LinRegCoeffEvaluator(pairwise, samevars);
		int validgroup=0;
		String[] values=null;
		...
		dsu.addnewvar("ref", "%1096%", Keywords.TEXTSuffix, clvar, tempmd);
	...
	*/
	public LinkedList<GetRequiredParameters> getparameters()
	{
		...
		dep = new String[1];
		dep[0]=Keywords.dict;
		parameters.add(new GetRequiredParameters(Keywords.varrow, "vars=all", true, 741, dep, "", 2));
		parameters.add(new GetRequiredParameters(Keywords.varcol, "vars=all", false, 742, dep, "", 2));
