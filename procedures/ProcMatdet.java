...
/**
* This is the procedure that evaluate the determinant of a matrix
* @author marco.scarno@gmail.com
* @date 14/02/2017
*/
public class ProcMatdet implements RunStep
{
	/**
	* Starts the execution of Proc Matdet and returns the corresponding message
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String keyword="Matdet "+dict.getkeyword();
		String description="Matdet "+dict.getdescription();
		...
		dsu.addnewvar("v0", "%1161%", Keywords.NUMSuffix, temph, temph);
