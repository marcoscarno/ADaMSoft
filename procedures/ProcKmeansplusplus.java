...
* @date 15/10/2017
*/
public class ProcKmeansplusplus extends ObjectTransformer implements RunStep
{
	/**
	...
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String [] requiredparameters=new String[] {Keywords.OUT.toLowerCase(), Keywords.dict, Keywords.var, Keywords.ngroup};
		...
		for (int i=0; i<totalgroupmodalities; i++)
		{
			...
			try
			{
				...
				java.util.List<CentroidCluster<DoublePoint>> clusterResults = clusterer.cluster(temp_points);
