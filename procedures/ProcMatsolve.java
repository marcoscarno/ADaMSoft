...
/**
* This is the procedure that Solves A*X = B, given A and B
* @author marco.scarno@gmail.com
* @date 14/02/2017
*/
public class ProcMatsolve implements RunStep
{
	/**
	...
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String keyword="Matsolve "+dicta.getkeyword()+" "+dictb.getkeyword();
		String description="Matsolve "+dicta.getdescription()+" "+dicta.getdescription();
		...
		try
		{
			...
			matRES=algebra.solve(matA, matB);
