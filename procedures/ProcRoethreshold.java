...
* @date 14/02/2017
*/
public class ProcRoethreshold extends ObjectTransformer implements RunStep
{
	/**
	* Starts the execution of Proc Roethreshold
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String [] optionalparameters=new String[] {Keywords.vargroup, Keywords.weight, Keywords.where, Keywords.errortype, Keywords.replace, Keywords.OUTC.toLowerCase(), Keywords.novgconvert, Keywords.noclforvg, Keywords.orderclbycode};
		...
		String keyword="Roethreshold "+dict.getkeyword();
		String description="Roethreshold "+dict.getdescription();
		...
		for (int r=0; r<varx.length; r++)
		{
			...
			for (int i=0; i<totalgroupmodalities; i++)
			{
				...
				if (isoutc)
				{
					...
					thresholdval[r]=rifmindiff;
					thresholdvalues.put(vargroupvalues, thresholdval);
				}
				valuestowrite[varg.length+1]=double2String(rifmindiff);
