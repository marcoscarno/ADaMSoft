...
/**
* This is the procedure that evaluate the condition of a matrix
* @author marco.scarno@gmail.com
* @date 14/02/2017
*/
public class ProcMatcond implements RunStep
{
	/**
	* Starts the execution of Proc Matcond and returns the corresponding message
	*/
	public Result executionresult(Hashtable<String, Object> parameters)
	{
		...
		String keyword="Matcond "+dict.getkeyword();
		String description="Matcond "+dict.getdescription();
		...
		dsu.addnewvar("v0", "%1157%", Keywords.NUMSuffix, temph, temph);

		if (!dw.opendatatable(dsu.getfinalvarinfo()))
			return new Result(dw.getmessage(), false, null);

		String[] valcond=new String[1];
		valcond[0]=String.valueOf(cond);
		dw.write(valcond);
