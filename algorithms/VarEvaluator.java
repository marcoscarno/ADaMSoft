...
/**
* This method evaluates the variances for several variables, also according do the values of the grouping variables
...
public class VarEvaluator
{
	...
	*/
	public VarEvaluator (boolean samplevariance)
	{
	...
	*/
	public void setValue(Vector<String> groupval, double[] val, double w)
	{
		...
		double[] sumsq=new double[val.length];
		if (test==null)
		{
