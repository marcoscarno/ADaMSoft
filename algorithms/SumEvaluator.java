...
/**
* This method evaluates the sum for several variables, also according to the values of the grouping variables
* @author marco.scarno@gmail.com
* @date 13/02/2017
*/
public class SumEvaluator
{
	Hashtable<Vector<String>, double[]> sum;
	/**
	*Initialise the main Objects, that will contains the sum
	*/
	public SumEvaluator ()
	{
		sum=new Hashtable<Vector<String>, double[]>();
	}
	/**
	* Evaluate the sum
	*/
