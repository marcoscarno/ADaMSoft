...
* @date 13/02/2017
*/
public class EditsChecker
{
	private final Polco polco;
	private PolcoCheckerAdapter<BigFraction, BigFraction[]> callback;
	/**
	 ...
	 */
	public EditsChecker() throws XmlConfigException
	{
		this(new Options());
	}
	/**
	 ...
	 * @exception	XmlConfigException if the configuration is erroneous
	 */
	public EditsChecker(Options options) throws XmlConfigException
	{
		try
		{
			try
	...
	*/
	public void getResult(double[][] eq, double[][] iq)
	{
		...
		try
		{
			callback = new PolcoCheckerAdapter<BigFraction, BigFraction[]>(fraOps.getArrayOperations());
