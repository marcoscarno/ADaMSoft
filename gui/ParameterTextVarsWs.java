...
* @version 1.0.0, rev.: 13/06/13 by marco
*/
public class ParameterTextVarsWs
{
	...
	public ParameterTextVarsWs (String parametername, int messagecode, JPanel actualpanel, Hashtable<String, String> dictionaries, String[] dep, boolean required)
	{
		...
		Action actionvar = new AbstractAction(Keywords.Language.getMessage(2160))
		{
			...
			public void actionPerformed(ActionEvent evt)
			{
				...
				if (fieldvar.getText().trim().equals(""))
	...
	public String toString()
	{
		...
		if (!value.equals(""))
		{
			if (value.indexOf(";")>0)
			{
				...
				{
					value=value+parametername+" "+pv[i];
					if (i<pv.length-1)
						value=value+";\n";
				}
			}
