...
*/
public class ParameterFile implements ActionListener
{
	...
	*/
	public ParameterFile (String filetype, String parametername, int messagecode, JPanel actualpanel, boolean required)
	{
