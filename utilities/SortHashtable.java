...
public class SortHashtable
{
	 ...
	 */
	public SortHashtable(Hashtable<String, String> table)
	{
	...
	*/
	...
	/**
	*Returns an Hashtable that contains the keys and the integer that refers to its position according to the value
	*/
	public Hashtable<String, Integer> getsortedhashtable()
	{
